...
const myFirstArray = ["Veronica", 13, true, "Hello", 11, false];
console.log(myFirstArray);

//Задание 2
//Создайте массив mySecondArray, заполните его любыми значениями. Выведите длину массива.
const mySecondArray = [1, 2, 3, 4, 5, 9, 10, 11, 12, 15, 16, 17]; // объявите переменную здесь
...
const myInformation = ["Veronica", 30, 4, "Без знака зодиака"];
...
const squaredNumbers = numbers.map(function(n) {return n**2});
...
const sm = (a) => a[0] + a[a.length - 1];
console.log(sm(numbers));
